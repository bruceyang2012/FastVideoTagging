base_dir = "/data/jh/notebooks/hudengjun/VisNet"

meta_dir = os.path.join(base_dir, "meta", "json")
image_dir = os.path.join(base_dir, "images")
#structured_dir = os.path.join(base_dir, "split_images")
...
for path in all_pair_file_paths:
    ...
    for product_id in product_ids:
        ...
        if os.path.exists(img_path) and not os.path.exists(dst_path):
